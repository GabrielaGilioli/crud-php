<?php
    ...
    function lerProdutos(PDO $conexao):array {
        ...
        //$sql = "SELECT id, nome, descricao, preço, quantidade, fabricante_id FROM produtos ORDER BY nome";

        //String com o comando SQL pata trazer o nome do fabricante (ATUAL - melhor)
    ...
    function inserirProdutos(PDO $conexao, string $nome, float $preco, int $quantidade, string $descricao, int $fabricanteId):void {
        ...
        try {
            ...
            $consulta->bindParam(':preco', $prco, PDO::PARAM_STR);
